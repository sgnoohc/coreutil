...
//    cout << endl;
    ...
    else if (filename.Contains("Summer16") || filename.Contains("TEST") || filename.Contains("PrivateWWW") || filename.Contains("TChiWH_HToVVTauTau_HToBB_mChargino200_mLSP50") || filename.Contains("GluGlu"))
    {
